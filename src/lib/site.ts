...
export const SITE = {
  ...
  name: "88서울마사지",
  /** 영문/슬로건 */
  brandEn: "88 SEOUL MASSAGE",
  /** 사이트 한 줄 소개 (80자 이내) */
  tagline: "88서울마사지 출장마사지·홈타이 서울·경기·인천·부산 지역별 방문 안내",
...
// ─────────────────────────────────────────────────────────────
// 텔레그램 링크 (제작·제휴 문의 전용 — 푸터에서만 사용)
//  ⚠️ 핸들은 실제 텔레그램 계정으로 교체하세요.
// ─────────────────────────────────────────────────────────────
export const TELEGRAM = {
  /** 웹사이트 제작 문의 텔레그램 */
  webBuild: "https://t.me/googleseolab",
  /** 제휴 문의 텔레그램 */
